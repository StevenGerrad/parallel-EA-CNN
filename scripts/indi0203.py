...
class EvoCNNModel(nn.Module):
    def __init__(self):
        ...
        self.layer_vertex.append(torch.nn.Sequential(torch.nn.BatchNorm2d(43),torch.nn.ReLU(inplace=True)))

        self.layer_vertex.append(torch.nn.Sequential(torch.nn.BatchNorm2d(125),torch.nn.ReLU(inplace=True)))

        self.layer_vertex.append(torch.nn.Sequential(torch.nn.Linear(130, 10)))
        ...
        self.layer_edge.append(torch.nn.Conv2d(43,119,kernel_size=(3,3),stride=pow(2, 0),padding=(1, 1)))
