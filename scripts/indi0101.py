...
class EvoCNNModel(nn.Module):
    def __init__(self):
        ...
        self.layer_vertex.append(torch.nn.Sequential(torch.nn.BatchNorm2d(7),torch.nn.ReLU(inplace=True)))

        self.layer_vertex.append(torch.nn.Sequential(torch.nn.Linear(7, 10)))
        ...
        self.layer_edge.append(torch.nn.Conv2d(3,7,kernel_size=(3,3),stride=pow(2, 0),padding=(1, 1)))
