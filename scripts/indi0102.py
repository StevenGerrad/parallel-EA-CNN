...
class EvoCNNModel(nn.Module):
    def __init__(self):
        ...
        self.layer_vertex.append(torch.nn.Sequential(torch.nn.BatchNorm2d(33),torch.nn.ReLU(inplace=True)))

        self.layer_vertex.append(torch.nn.Sequential(torch.nn.Linear(41, 10)))
        ...
        self.layer_edge.append(torch.nn.Conv2d(11,30,kernel_size=(3,3),stride=pow(2, 0),padding=(1, 1)))
