...
class EvoCNNModel(nn.Module):
    def __init__(self):
        ...
        self.op0 = ResNetUnit(amount=7, in_channel=3, out_channel=128)
        self.op1 = DenseNetUnit(k=40, amount=3, in_channel=128, out_channel=152, max_input_channel=32)
        self.op6 = ResNetUnit(amount=9, in_channel=152, out_channel=64)
        self.op7 = DenseNetUnit(k=20, amount=4, in_channel=64, out_channel=144, max_input_channel=64)
        self.op8 = DenseNetUnit(k=20, amount=5, in_channel=144, out_channel=164, max_input_channel=64)

        #linear unit
        self.linear = nn.Linear(656, 10)
